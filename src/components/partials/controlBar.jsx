  ...
  render() {
    ...
    return (
      <div className="btn-down">
        ...
        <IconButton style={{ color: "#424242" }} onClick={onToggleVideo}>
        ...
        <IconButton style={{ color: "#424242" }} onClick={onToggleAudio}>
        ...
        <Badge
          ...
          onClick={onOpenChat}
        >
          <IconButton style={{ color: "#424242" }} onClick={onOpenChat}>
            <ChatIcon />
          </IconButton>
        </Badge>
